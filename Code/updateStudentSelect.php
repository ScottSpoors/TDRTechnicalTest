...
<head>
	<meta charset="UTF-8">
	<title>TDR Technical Test - Select Record to Update</title>
</head>
<body>
	<?php
		echo
		...
		echo"<br>
			<form method ='get' action='updateStudentForm.php'>
				<label>Select a Record to Update <select name='studentSelect'>";
